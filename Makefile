...
#
CC = g++
CFLAGS = -O3 -c -std=c++11 -Wall -I/usr/local/include/SDL2 -I /usr/local/include -I. -I../easyloggingpp/src -include "precompiled.h"
LDFLAGS = -O3 -L /usr/local/lib -lSDL2_image -lSDL2 -lcurses
